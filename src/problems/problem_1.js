...
const explanation = `The calculation is correct and celsius value is produced, however it was not being put on the screen because react 
didn't know that celsius was updated. Celsius was defined using 'let' and reset using '='. In order to let react know that celsius was updated, I gave it a state and updated it through the usestate function.`;
...
export function Problem () {
    ...
    const[celsius, setCel] = useState(-40);
    // let celsius = -40;
