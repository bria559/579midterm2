...
export function Problem (props) {
    ...
    const [propss, setProps] = useState(1);
    ...
    return <div className="btn-group">
            <button type="button" className="btn btn-primary" onClick={decrementClick}>-</button>
            <span id="num_sel">{propss}</span>
            <button type="button" className="btn btn-primary" onClick={incrementClick}>+</button>
        </div>;
}